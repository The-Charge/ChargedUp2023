...
public class MoveArmSimple extends CommandBase {
  ...
  @Override
  public void execute() {
    double xSpeed = -RobotContainer.getInstance().getarmController().getRawAxis(1) / 250; //.getleftJoystick().getY() / 250;
    double ySpeed = -RobotContainer.getInstance().getarmController().getRawAxis(3) / 250; //.getrightJoystick().getY() / 250;
    ...
    targetX = m_magicArm.getLigitX(targetX + xSpeed);
    targetY = m_magicArm.getLigitY(targetX, targetY + ySpeed);
