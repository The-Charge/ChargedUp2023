...
public class MoveArmSimple extends CommandBase {
  ...
  @Override
  public void execute() {
    // We are running out of buttons for half speed control.  So push joysticks towards each other is 
    ...
    // First time joysticks not moved, get current arm tip position and keep it there.
