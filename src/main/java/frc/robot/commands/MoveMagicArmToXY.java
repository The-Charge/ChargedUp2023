...
public class MoveMagicArmToXY extends CommandBase {
  ...
  @Override
  public void initialize() {canMove = true;}

  // Called every time the scheduler runs while the command is scheduled.
  @Override
  public void execute() {canMove = m_arm.moveToXYFromNeutral(m_X, m_Y);}
  ...
  public boolean isFinished() {
    ...
    return(((xy[0]-m_X)*(xy[0]-m_X) + (xy[1]-m_Y)*(xy[1]-m_Y) < 0.02) || (!canMove));
  }
}
