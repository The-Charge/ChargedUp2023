...
public class RobotContainer {
  ...
  private void pathSendableChooserInit() {
    ...
    test[0] = "None";
    test[1] = "BottomOnePiece + ChargeStation";
    test[2] = "BottomOnePiece";
    test[3] = "BottomTwoPiece + ThirdPickup";
    test[4] = "BottomTwoPiece";
    test[5] = "Forward 2M";
    test[6] = "MiddleOnePiece";
    test[7] = "MiddlePiece";
    test[8] = "Reverse Waypoint";
    test[9] = "TopOnePiece + ChargeStation";
    test[10] = "TopOnePiece";
    test[11] = "TopOnePieceEvents";
    test[12] = "TopTwoPiece + ThirdPickup";
    test[13] = "TopTwoPiece";
    test[14] = "Turn 90";
    test[15] = "Drive And Climb";
    test[16] = "Drive Over";
    test[17] = "Driver Over Back Climb";
    test[18] = "Score High Cone";
    test[19] = "Score High Ball";
