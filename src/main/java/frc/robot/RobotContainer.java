...
private final Joystick leftJoystick = new Joystick(0);
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("Align", new Align( m_camera ));
...
moveArmToNeutralBtn.onTrue(new MoveArmToNeutral( m_magicArm ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
moveArmFrontHighBtn.onTrue(new MoveMagicArmToXY( m_magicArm ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
alignBtn.onTrue(new Align( m_drivetrain, m_camera ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
