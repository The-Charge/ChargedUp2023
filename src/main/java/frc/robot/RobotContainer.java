...
private final Joystick leftJoystick = new Joystick(0);
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("ClawSafety", new ClawSafety( m_claw ));
    SmartDashboard.putData("MoveArmSimple", new MoveArmSimple( m_magicArm ));
    SmartDashboard.putData("MoveArmToNeutral", new MoveArmToNeutral( m_magicArm ));
    SmartDashboard.putData("MoveMagicArmToXY", new MoveMagicArmToXY( m_magicArm ));
  ...
  private void configureButtonBindings() {
    ...
    moveArmFrontLowBtn.onTrue(
        (new MoveMagicArmToXY(m_magicArm, 1.0, 0.1)).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

    JoystickButton moveArmFrontHighBtn = new JoystickButton(armController, 4);
    moveArmFrontHighBtn
        .onTrue((new MoveMagicArmToXY(m_magicArm, 1.2, 1)).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
