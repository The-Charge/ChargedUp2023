...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton turn90Btn = new JoystickButton(leftJoystick, 1);
    turn90Btn.onTrue(new TurnNRelative(90, m_drivetrain));

    final JoystickButton turn180Btn = new JoystickButton(leftJoystick, 3);
    turn180Btn.onTrue(new TurnNRelative(180, m_drivetrain));
