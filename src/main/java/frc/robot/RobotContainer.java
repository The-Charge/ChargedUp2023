...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("score high goal", scoreHighCone);
  ...
  private void configureButtonBindings() {
    ...
    //Claw Buttons
    final JoystickButton closeClawBtn = new JoystickButton(armController, 2); // was 5
    closeClawBtn.onTrue(new CloseClaw(m_claw).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
    final JoystickButton openClawBtn = new JoystickButton(armController, 4); //was 6
    ...
    Command armBakcMid = (new MoveMagicArmToXY(m_arm, -ArmConstants.midGoalX, ArmConstants.midGoalY, 5000)).withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    ...
    Command manualHiFront = (new ManualHighCone(m_arm, false)).withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command manualHiBack = (new ManualHighCone(m_arm, true)).withInterruptBehavior(InterruptionBehavior.kCancelSelf);
...
*/
    ...
    JoystickButton middleButton1 = new JoystickButton(armController, 11);
    middleButton1.onTrue(armNeutral);
    JoystickButton middleButton2 = new JoystickButton(armController, 12);
    ...
    JoystickButton frontHiButton = new JoystickButton(armController, 10);
    frontHiButton.onTrue(armFrontHigh);
    JoystickButton backMidButton = new JoystickButton(armController, 5);
    backMidButton.onTrue(armBakcMid);
    JoystickButton frontMidButton = new JoystickButton(armController, 6);
    frontMidButton.onTrue(armFrontMid);
    JoystickButton backLowButton = new JoystickButton(armController, 7);
    backLowButton.onTrue(armBackLow);
    JoystickButton frontLowButton = new JoystickButton(armController, 8);
    frontLowButton.onTrue(armFrontLow);
