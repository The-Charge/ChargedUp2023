...
final JoystickButton turnNDegreesBtn = new JoystickButton(leftJoystick, 1);        
turnNDegreesBtn.onTrue(new TurnNRelative( m_drivetrain ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
