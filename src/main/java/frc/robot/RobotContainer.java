...
private final Joystick leftJoystick = new Joystick(0);
  ...
  private RobotContainer() {
    ...
    //SmartDashboard.putData("TurnNRelative", new TurnNRelative( m_drivetrain ));
...
final JoystickButton turnNDegrees90Btn = new JoystickButton(leftJoystick, 1);        
turnNDegrees90Btn.onTrue(new TurnNRelative( m_drivetrain, 90 ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                
final JoystickButton turnNDegrees180Btn = new JoystickButton(leftJoystick, 2);        
turnNDegrees180Btn.onTrue(new TurnNRelative( m_drivetrain, 180 ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
