...
import frc.robot.commands.ManualHighCone;
import frc.robot.commands.MoveArmSimple;
import frc.robot.commands.MoveArmToNeutral;
import frc.robot.commands.MoveMagicArmToXY;
...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    m_claw.setDefaultCommand(new ClawSafety(m_claw)); 
