...
public class RobotContainer {
  ...
  private void pathSendableChooserInit() {
    ...
    tempPathNames[17] = "TopOnePieceEventsShort";
  ...
  private void configureButtonBindings() {
    ...
    Command armFrontLow = (new MoveMagicArmToXY(m_arm, ArmConstants.pickUpX, ArmConstants.pickUpY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command armBackLow = (new MoveMagicArmToXY(m_arm, -ArmConstants.pickUpX, ArmConstants.pickUpY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command armFrontMid = (new MoveMagicArmToXY(m_arm, ArmConstants.midGoalX, ArmConstants.midGoalY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command armBackMid = (new MoveMagicArmToXY(m_arm, -ArmConstants.midGoalX, ArmConstants.midGoalY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command armFrontHigh = (new MoveMagicArmToXY(m_arm, ArmConstants.hiGoalX, ArmConstants.hiGoalY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command armBackHigh = (new MoveMagicArmToXY(m_arm, -ArmConstants.hiGoalX, ArmConstants.hiGoalY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command armFrontStation = (new MoveMagicArmToXY(m_arm, ArmConstants.stationX, ArmConstants.stationY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command armBackStation = (new MoveMagicArmToXY(m_arm, -ArmConstants.stationX, ArmConstants.stationY, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command manualHighFront = (new ManualHighCone(m_arm, false, 8000))
        .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    Command manualHighBack = (new ManualHighCone(m_arm, true, 8000))
    .withInterruptBehavior(InterruptionBehavior.kCancelSelf);
    /*
