...
alignBtn.whileTrue(new Align( m_drivetrain, m_camera ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton pipelineSwitchBtn = new JoystickButton(leftJoystick, 5);        
pipelineSwitchBtn.onTrue(new PipelineSwitch( m_camera ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
