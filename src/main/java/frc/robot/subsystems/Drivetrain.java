...
public class Drivetrain extends SubsystemBase {
  ...
  */
  public Drivetrain() {
    ...
    leftFrontMotor = new WPI_TalonSRX(Constants.DriveConstants.kLeftMotorFrontPort);

    leftRearMotor = new WPI_TalonSRX(Constants.DriveConstants.kLeftMotorRearPort);

    left = new MotorControllerGroup(leftFrontMotor, leftRearMotor);
    addChild("left", left);

    rightFrontMotor = new WPI_TalonSRX(Constants.DriveConstants.kRightMotorFrontPort); 

    rightRearMotor = new WPI_TalonSRX(Constants.DriveConstants.kRightMotorRearPort);
